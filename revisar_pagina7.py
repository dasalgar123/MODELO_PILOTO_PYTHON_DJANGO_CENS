...
# Extraer IDs del mapping con sus líneas (PÁGINA 7: líneas 245-259 aproximadamente)
mapping_dict = {}
for i, line in enumerate(mapping_lines, 1):
    # Solo líneas de la página 7 (basado en comentarios)
    if i >= 245 and i <= 259:
...
# Extraer IDs del HTML de la página 7 (líneas 482-537 aproximadamente)
html_dict = {}
for i, line in enumerate(html_lines, 1):
    # Solo líneas de la página 7
    if i >= 482 and i <= 537:
...
# Obtener todos los IDs únicos de la página 7
all_ids = sorted(set(mapping_dict.keys()) | set(html_dict.keys()))

# Crear tabla
print("=" * 180)
print("REVISION PAGINA 7: INSTALACIONES GENERALES")
print("=" * 180)
...
if not solo_mapping and not solo_html:
    print("\n¡Perfecto! Todos los IDs de la PAGINA 7 coinciden.")
